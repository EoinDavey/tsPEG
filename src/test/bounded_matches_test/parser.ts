...
export type S_$0 = S_$0_1 | S_$0_2 | S_$0_3;
...
export class Parser {
    ...
    public matchS_$0($$dpth: number, $$cr?: ErrorTracker): Nullable<S_$0> {
        return this.choice<S_$0>([
            () => this.matchS_$0_1($$dpth + 1, $$cr),
            () => this.matchS_$0_2($$dpth + 1, $$cr),
            () => this.matchS_$0_3($$dpth + 1, $$cr),
        ]);
    }
