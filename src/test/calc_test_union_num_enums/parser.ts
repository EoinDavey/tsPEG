...
export type ASTKinds = 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7;

export class SUM {
    public kind: 0 = ASTKinds.SUM;
    public head: FAC;
    public tail: SUM_$0[];
    public value: number;
