...
export class Parser {
    ...
    public matchA($$dpth: number, $$cr?: ContextRecorder): Nullable<A> {
        const fn = () => {
    ...
    public matchA_1($$dpth: number, $$cr?: ContextRecorder): Nullable<A_1> {
    ...
    public matchA_2($$dpth: number, $$cr?: ContextRecorder): Nullable<A_2> {
        return this.regexAccept(String.raw`(?:a)`, $$dpth + 1, $$cr);
    }
    public matchB($$dpth: number, $$cr?: ContextRecorder): Nullable<B> {
        return this.choice<B>([
            () => this.matchB_1($$dpth + 1, $$cr),
            () => this.matchB_2($$dpth + 1, $$cr),
        ]);
    }
    public matchB_1($$dpth: number, $$cr?: ContextRecorder): Nullable<B_1> {
        return this.matchA($$dpth + 1, $$cr);
    }
    public matchB_2($$dpth: number, $$cr?: ContextRecorder): Nullable<B_2> {
